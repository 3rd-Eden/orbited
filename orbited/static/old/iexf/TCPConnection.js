...
// start @include(ServerSentEvents-IE.js)
...
// end @include(ServerSentEvents-IE.js)

        
// start @include(base2.js)
var base2 = {
  name:    "base2",
  version: "1.0 (beta 2)",
  exports:
...
// end @include(base2.js)

        break;
    case 'firefox':
        
// start @include(ServerSentEvents-Gecko.js)
...
// end @include(ServerSentEvents-Gecko.js)

        break;
}

// start @include(ReliableTCPConnection.js)

ReliableTCPConnection = function() {
    var self = this;
    self.readyState = -1
...
//            alert('using XSubdomainRequest')
            ...
            throw new Error("Invalid domain. ReliableTCPConnection instances may only connect to same-domain or sub-domain hosts.")
        }
        session = _session;
...
// end @include(ReliableTCPConnection.js)


// start @include(xdr/XSubdomainRequest.js)
...
// end @include(xdr/XSubdomainRequest.js)
