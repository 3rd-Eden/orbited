...
//  alert("switching from: " + document.domain + "to: " + TOP_DOMAIN);
  // document.domain = TOP_DOMAIN;
  // $.get(APP_HOSTNAME + url, params); // ajax get request
...
function connect() {
  if (loggedOn) {
    ...
    sourceURL = ORBIT_HOSTNAME + '/chat|' + nickname + ',0,iframe';
    $("#events").attr("src", sourceURL);
